...
const allNodes = [
  ...
  // ),
  ...Object.values(markers.monsters.scorpion).map(toNode({ type: 'scorpion' })),
  ...Object.values(markers.monsters.lion).map(toNode({ type: 'lion' })),
  ...Object.values(markers.monsters.wolf).map(toNode({ type: 'wolf' })),
];
