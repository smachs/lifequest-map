import { Accordion, Anchor, List, MantineProvider, Modal } from '@mantine/core';
        ...
        <Accordion>
          ...
          <Accordion.Item value="Is the node timer allowed?">
            ...
            <Accordion.Panel>
              ...
              But it's allowed to trigger a timer by hand (you need to press the
              action hotkey). You can not be sure that the node is farmed in the
              meantime with this approach, but it's safe to use.
            </Accordion.Panel>
          </Accordion.Item>
          ...
          <Accordion.Item value="I want to update my username">
            ...
            <Accordion.Panel>
              Your username is your Steam Profile Name. If you updated it on
