...
root.render(
  <main>
    ...
    <h2>tl;dr</h2>
    <p>No Cross-Site trackers and other creepy things.</p>
    ...
    <p>
      ...
      and/or collect in Aeternum Map. This policy is not applicable to any
    ...
    <p>
      ...
      you such as your name, steam username, the contents of the message and/or
    ...
    <p>
      Aeternum Map follows a standard procedure of using log files. These files
    ...
    <p>
      Like any other website, Aeternum Map uses 'cookies'. These cookies are
    ...
    <p>
      ...
      advertising partners of Aeternum Map.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Aeternum Map, which are sent
    ...
    <p>
      Note that Aeternum Map has no access to or control over these cookies that
    ...
    <p>
      Aeternum Map does not knowingly collect any Personal Identifiable
