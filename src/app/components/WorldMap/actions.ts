...
const actions: {
  ...
  chestsEliteAncient: respawnAction(600),
  chestsEliteSupplies: respawnAction(600),
  chestsLargeAlchemy: respawnAction(600),
  chestsLargeAncient: respawnAction(600),
  chestsLargeProvisions: respawnAction(600),
  chestsLargeSupplies: respawnAction(600),
  ...
  iron: respawnAction(600),
  lodestone: respawnAction(960),
  oil: respawnAction(600),
  orichalcum: respawnAction(1260),
  platinum: respawnAction(2700),
  saltpeter: respawnAction(600),
  silver: respawnAction(600),
  starmetal: respawnAction(960),
